          ...
          <div className="row">
            <div className="col-lg-7">
              <div className="hero-banner-two-head-cust">
                <h1>UK Wholesale Granite Headstones Supplier</h1>

                <p>
                  Premium granite memorials for funeral homes, memorial dealers
                  and trade buyers across the UK.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="col-lg-9">
              <div className="heading-center p-b-40">
                ...
                <p>
                  ...
                  range, our team is here to support your growth.
                </p>
              </div>
            ...
            <div className="col-lg-12">
              <div className="card-05">
                <div className="card-05-item">
                  ...
                  <p>Premium granite crafted with attention to detail.</p>
                </div>
                ...
                <div className="card-05-item">
                  ...
                  <p>Best wholesale pricing for memorial dealers.</p>
                </div>
                ...
                <div className="card-05-item">
                  ...
                  <p>Reliable shipping and UK-wide delivery.</p>
                </div>
                ...
                <div className="card-05-item">
                  ...
                  <p>Large-scale supply support for businesses.</p>
                </div>
                ...
                <div className="card-05-item">
                  ...
                  <p>Exporting memorials globally since 1984.</p>
                </div>
              </div>
            </div>
          </div>
